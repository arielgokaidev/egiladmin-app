...
*/
    ...
    public void dialogoIngresar() {
        ...
        // Titulo
        builder.setTitle("Ingresar Reservas");
    ...
    public void dialogoLeer() {
        ...
        View view = inflater.inflate(R.layout.dialog_leer_reserva, null);

        builder.setTitle("Ver Reservas");
        builder.setView(view);
    ...
    public void dialogoEliminar() {
        ...
        builder.setView(inflater.inflate(R.layout.dialog_eliminar_reserva, null));
